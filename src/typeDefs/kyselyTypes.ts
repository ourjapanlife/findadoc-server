...
export interface SubmissionsTable {
  ...
  facility_partial: ColumnType<gqlTypes.FacilitySubmission | null, gqlTypes.FacilitySubmission | null, gqlTypes.FacilitySubmission | null>
  healthcare_professionals_partial: ColumnType<gqlTypes.HealthcareProfessionalSubmission[] | null, gqlTypes.HealthcareProfessionalSubmission[] | null, gqlTypes.HealthcareProfessionalSubmission[] | null>
  firestore_id: string | null
}
