...
export enum Degree {
  DoctorOfDentalSurgery = 'DOCTOR_OF_DENTAL_SURGERY',
  DoctorOfMedicine = 'DOCTOR_OF_MEDICINE',
  DoctorOfOsteopathicMedicine = 'DOCTOR_OF_OSTEOPATHIC_MEDICINE',
...
export type HealthcareProfessionalInput = {
  ...
  degrees: Array<InputMaybe<Degree>>;
