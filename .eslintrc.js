...
module.exports = {
  ...
  rules: {
    ...
    'max-len': ['error', 120, 'error', { ignoreUrls: true, ignoreRegExpLiterals: true }],
    ...
    // { blankLine: 'any', prev: ['const', 'let', 'var'], next: ['const', 'let', 'var'] },{ blankLine: 'always', prev: '*', next: 'return' }],
